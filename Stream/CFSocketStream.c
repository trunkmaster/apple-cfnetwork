...
static CFIndex     _SocketStreamRead(CFReadStreamRef         stream,
                                     UInt8*                  buffer,
...
static CFIndex     _SocketStreamWrite(CFWriteStreamRef        stream,
                                      const UInt8*            buffer,
                                      CFIndex                 bufferLength,
                                      CFStreamError*          error,
                                      _CFSocketStreamContext* ctxt);
...
extern void      _CFStreamCreatePairWithCFSocketSignaturePieces(CFAllocatorRef    alloc,
...
extern void      _CFSocketStreamCreatePair(CFAllocatorRef           alloc,
                                           CFStringRef              host,
                                           UInt32                   port,
                                           CFSocketNativeHandle     s,
                                           const CFSocketSignature* sig,
                                           CFReadStreamRef*         readStream,
                                           CFWriteStreamRef*        writeStream);
...
static const CFReadStreamCallBacks kSocketReadStreamCallBacks = {
    1,    /* version */
    NULL, /* create */
    (void (*)(CFReadStreamRef, void*))_SocketStreamFinalize,
    (CFStringRef(*)(CFReadStreamRef, void*))_SocketStreamCopyDescription,
    (Boolean(*)(CFReadStreamRef, CFErrorRef*, Boolean*, void*))_SocketStreamOpen,
    (Boolean(*)(CFReadStreamRef, CFErrorRef*, void*))_SocketStreamOpenCompleted,
    (CFIndex(*)(CFReadStreamRef, UInt8*, CFIndex, CFErrorRef*, Boolean*, void*))_SocketStreamRead,
    NULL, /* getbuffer */
    (Boolean (*)(CFReadStreamRef, CFErrorRef*, void*))_SocketStreamCanRead,
...
static const CFWriteStreamCallBacks kSocketWriteStreamCallBacks = {
    1,    /* version */
    NULL, /* create */
    (void (*)(CFWriteStreamRef, void*))_SocketStreamFinalize,
    (CFStringRef(*)(CFWriteStreamRef, void*))_SocketStreamCopyDescription,
    (Boolean(*)(CFWriteStreamRef, CFErrorRef*, Boolean*, void*))_SocketStreamOpen,
    (Boolean(*)(CFWriteStreamRef, CFErrorRef*, void*))_SocketStreamOpenCompleted,
    (CFIndex(*)(CFWriteStreamRef, const UInt8*, CFIndex, CFErrorRef*, void*))_SocketStreamWrite,
    (Boolean(*)(CFWriteStreamRef, CFErrorRef*, void*))_SocketStreamCanWrite,
...
/* static */ CFStringRef _SocketStreamCopyDescription(CFTypeRef stream, _CFSocketStreamContext* ctxt)
{
  return CFStringCreateWithFormat(CFGetAllocator(stream), NULL, kCFSocketStreamDescriptionFormat, stream, ctxt->_flags, ctxt->_clientReadStream,
                                  ctxt->_clientWriteStream, ctxt->_socket, ctxt->_properties);
}
  ...
  while (1) {
    ...
    if (!ctxt->_error.error && !__CFBitIsSet(ctxt->_flags, kFlagBitCanRead)) {
      ...
      if (cancel) {
        ...
        CFArrayApplyFunction(ctxt->_schedulables, CFRangeMake(0, CFArrayGetCount(ctxt->_schedulables)),
                             (CFArrayApplierFunction)_SchedulablesScheduleApplierFunction, loopAndMode);
        ...
        } while (!ctxt->_error.error && !__CFBitIsSet(ctxt->_flags, kFlagBitCanRead) && (0 < (interval = (later - CFAbsoluteTimeGetCurrent()))));
        ...
        CFArrayApplyFunction(ctxt->_schedulables, CFRangeMake(0, CFArrayGetCount(ctxt->_schedulables)),
                             (CFArrayApplierFunction)_SchedulablesUnscheduleApplierFunction, loopAndMode);
  ...
  */
  ...
  if (result > 0) {
    ...
    if (!__CFBitIsSet(ctxt->_flags, kFlagBitHasHandshakes)) {
      ...
      if (handshakes && CFArrayGetCount(handshakes) && (_PerformCONNECTHaltHandshake_NoLock == CFArrayGetValueAtIndex(handshakes, 0))) {
        /* Can still read?  If not, re-enable. */
  ...
  while (1) {
    ...
    if (!ctxt->_error.error && !__CFBitIsSet(ctxt->_flags, kFlagBitCanWrite)) {
      ...
      if (cancel) {
        ...
        } while (!ctxt->_error.error && !__CFBitIsSet(ctxt->_flags, kFlagBitCanWrite) && (0 < (interval = (later - CFAbsoluteTimeGetCurrent()))));
...
/* static */ void _SocketStreamClose(CFTypeRef stream, _CFSocketStreamContext* ctxt)
{
  ...
  CFArrayApplyFunction(ctxt->_schedulables, CFRangeMake(0, CFArrayGetCount(ctxt->_schedulables)),
                       (CFArrayApplierFunction)_SchedulablesUnscheduleFromAllApplierFunction, loops);
...
/* static */ Boolean _SocketStreamSetProperty(CFTypeRef stream, CFStringRef propertyName, CFTypeRef propertyValue, _CFSocketStreamContext* ctxt)
{
  ...
  if (CFEqual(propertyName, kCFStreamPropertyUseAddressCache) || CFEqual(propertyName, _kCFStreamSocketIChatWantsSubNet)) {
    if (propertyValue)
    ...
    CFMutableDictionaryRef settings =
        CFDictionaryCreateMutable(CFGetAllocator(ctxt->_properties), 0, &kCFTypeDictionaryKeyCallBacks, &kCFTypeDictionaryValueCallBacks);
  ...
  else if (CFEqual(propertyName, _kCFStreamPropertyHostForOpen) || CFEqual(propertyName, _kCFStreamPropertyReadTimeout) ||
           CFEqual(propertyName, _kCFStreamPropertyWriteTimeout) || CFEqual(propertyName, _kCFStreamPropertyAutoConnectPriority) ||
  ...
  else if (CFEqual(propertyName, _kCFStreamPropertyRecvBufferSize) && !__CFBitIsSet(ctxt->_flags, kFlagBitOpenStarted) &&
  ...
  if (ctxt->_error.error) {
    ...
    */
    if ((!c || !*((CFIndex*)CFDataGetBytePtr(c))) && (ctxt->_clientReadStream && __CFBitIsSet(ctxt->_flags, kFlagBitReadStreamOpened))) {
...
/* static */ void _SocketCallBack(CFSocketRef s, CFSocketCallBackType type, CFDataRef address, const void* data, _CFSocketStreamContext* ctxt)
{
...
/* static */ void _HostCallBack(CFHostRef theHost, CFHostInfoType typeInfo, const CFStreamError* error, _CFSocketStreamContext* ctxt)
{
  int               i;
...
/* static */ void _NetServiceCallBack(CFNetServiceRef theService, CFStreamError* error, _CFSocketStreamContext* ctxt)
{
  int               i;
  CFMutableArrayRef loops[3];
  CFArrayRef        addresses;
  ...
  if (ctxt->_error.error) {
    /* Copy the error for notification. */
    memmove(&ctxt->_error, error, sizeof(CFStreamError));
...
/* static */ void _SocksHostCallBack(CFHostRef theHost, CFHostInfoType typeInfo, const CFStreamError* error, _CFSocketStreamContext* ctxt)
{
  CFStreamError err;
...
/* static */ _CFSocketStreamContext* _SocketStreamCreateContext(CFAllocatorRef alloc)
{
  ...
  _CFSocketStreamContext* ctxt = (_CFSocketStreamContext*)CFAllocatorAllocate(alloc, sizeof(ctxt[0]), 0);
  ...
  if (ctxt) {
    ...
    ctxt->_properties   = CFDictionaryCreateMutable(alloc, 0, &kCFTypeDictionaryKeyCallBacks, &kCFTypeDictionaryValueCallBacks);

    /* If anything failed, need to cleanup and toss result */
    if (!ctxt->_readloops || !ctxt->_writeloops || !ctxt->_sharedloops || !ctxt->_schedulables || !ctxt->_properties) {
      ctxt = NULL;
    }
  }
...
/* static */ void _SocketStreamSchedule_NoLock(CFTypeRef stream, CFRunLoopRef runLoop, CFStringRef runLoopMode, _CFSocketStreamContext* ctxt)
{
   ...
   */
  if ((kCFNotFound == _SchedulesFind(ctxt->_sharedloops, runLoop, runLoopMode)) && (kCFNotFound == _SchedulesFind(loops, runLoop, runLoopMode))) {
    ...
    if (isReadStream) {
      if (__CFBitIsSet(ctxt->_flags, kFlagBitCanRead) && (CFArrayGetCount(loops) + CFArrayGetCount(ctxt->_sharedloops) == 4)) {
        CFReadStreamSignalEvent((CFReadStreamRef)stream, kCFStreamEventHasBytesAvailable, NULL);
      }
    }

    else {
      if (__CFBitIsSet(ctxt->_flags, kFlagBitCanWrite) && (CFArrayGetCount(loops) + CFArrayGetCount(ctxt->_sharedloops) == 4)) {
    ...
    /* Need to inject the port value now. */
      ...
      switch (((struct sockaddr*)CFDataGetBytePtr(address))->sa_family) {
        case AF_INET:
          ...
          address = CFDataCreateMutableCopy(CFGetAllocator(address), 0, address);
...
/* static */ Boolean _CFSocketCan(CFSocketRef s, int mode)
{
  ...
  */
  ...
  val = select(fd + 1, (mode & kSelectModeRead ? setptr : NULL), (mode & kSelectModeWrite ? setptr : NULL),
               (mode & kSelectModeExcept ? setptr : NULL), &timeout);
...
/* static */ Boolean _SocketStreamStartLookupForOpen_NoLock(_CFSocketStreamContext* ctxt)
{
  ...
  do {
    ...
    if (proxy) {
      ...
      lookup = CFHostCreateWithName(CFGetAllocator(ctxt->_properties), (CFStringRef)CFDictionaryGetValue(proxy, kCFStreamPropertySOCKSProxyHost));
      ...
      */
      if (lookup && CFEqual(_GetSOCKSVersion(proxy), kCFStreamSocketSOCKSVersion4)) {
        ...
        else if (_ScheduleAndStartLookup(extra, loops, &ctxt->_error, (const void*)_SocksHostCallBack, ctxt)) {
    ...
    /* If there is no SOCKS proxy, it could be a CONNECT proxy. */
      ...
      /* Create the host from the host name */
      lookup = CFHostCreateWithName(CFGetAllocator(ctxt->_properties), (CFStringRef)CFDictionaryGetValue(proxy, kCFStreamPropertyCONNECTProxyHost));
    }
    ...
    result      = _ScheduleAndStartLookup(lookup, loops, &ctxt->_error,
                                          ((lookup_type == host_type) ? (const void*)_HostCallBack : (const void*)_NetServiceCallBack), ctxt);
...
/* static */ Boolean _SocketStreamCreateSocket_NoLock(_CFSocketStreamContext* ctxt, CFDataRef address)
{
  do {
    ...
    ctxt->_socket =
        CFSocketCreate(CFGetAllocator(ctxt->_properties), protocolFamily, socketType, protocol, kSocketEvents, (CFSocketCallBack)_SocketCallBack, &c);
    ...
    flags   = CFSocketGetSocketFlags(ctxt->_socket) & ~kCFSocketAutomaticallyReenableReadCallBack & ~kCFSocketAutomaticallyReenableWriteCallBack;
  ...
  do {
    ...
    /* If there is no lookup and no socket, something is bad. */
      ...
      if (!ctxt->_socket) {
        ...
        ctxt->_socket = CFSocketCreateWithNative(CFGetAllocator(ctxt->_properties), *((CFSocketNativeHandle*)CFDataGetBytePtr(wrapper)),
                                                 kSocketEvents, (CFSocketCallBack)_SocketCallBack, &c);
...
/* static */ Boolean _SocketStreamCan(_CFSocketStreamContext* ctxt, CFTypeRef stream, int test, CFStringRef mode, CFStreamError* error)
{
  ...
  if (!ctxt->_error.error && !result) {
    ...
    if (!__CFBitIsSet(ctxt->_flags, test + kFlagBitPollOpen) && ((CFArrayGetCount(ctxt->_sharedloops) + CFArrayGetCount(loops)) > 2)) {
      ...
      if (ctxt->_socket && (CFArrayGetCount(ctxt->_schedulables) == 1) && (ctxt->_socket == CFArrayGetValueAtIndex(ctxt->_schedulables, 0))) {
...
/* static */ void _SocketStreamAddReachability_NoLock(_CFSocketStreamContext* ctxt)
{
  ...
  if (ctxt->_socket && __CFBitIsSet(ctxt->_flags, kFlagBitOpenComplete) && !reachability) {
    ...
    if (localAddr && peerAddr) {
      ...
      SCNetworkReachabilityRef reachability = SCNetworkReachabilityCreateWithAddressPair(
          CFGetAllocator(ctxt->_properties), (const struct sockaddr*)CFDataGetBytePtr(localAddr), (const struct sockaddr*)CFDataGetBytePtr(peerAddr));
...
/* static */ CFComparisonResult _OrderHandshakes(_CFSocketStreamPerformHandshakeCallBack fn1,
                                                 _CFSocketStreamPerformHandshakeCallBack fn2,
                                                 void*                                   context)
{
  if (!fn1)
  ...
  */
  ...
  if (*fn1 == _PerformSOCKSv5Handshake_NoLock)
    return kCFCompareLessThan;
  if (*fn2 == _PerformSOCKSv5Handshake_NoLock)
    return kCFCompareGreaterThan;

  if (*fn1 == _PerformSOCKSv5UserPassHandshake_NoLock)
    return kCFCompareLessThan;
  if (*fn2 == _PerformSOCKSv5UserPassHandshake_NoLock)
    return kCFCompareGreaterThan;

  if (*fn1 == _PerformSOCKSv5PostambleHandshake_NoLock)
    return kCFCompareLessThan;
  if (*fn2 == _PerformSOCKSv5PostambleHandshake_NoLock)
    return kCFCompareGreaterThan;

  if (*fn1 == _PerformSOCKSv4Handshake_NoLock)
    return kCFCompareLessThan;
  if (*fn2 == _PerformSOCKSv4Handshake_NoLock)
    return kCFCompareGreaterThan;

  if (*fn1 == _PerformCONNECTHaltHandshake_NoLock)
    return kCFCompareLessThan;
  if (*fn2 == _PerformCONNECTHaltHandshake_NoLock)
    return kCFCompareGreaterThan;

  if (*fn1 == _PerformCONNECTHandshake_NoLock)
    return kCFCompareLessThan;
  if (*fn2 == _PerformCONNECTHandshake_NoLock)
    return kCFCompareGreaterThan;

#if defined(__MACH__)
  if (*fn1 == _PerformSecuritySendHandshake_NoLock)
    return kCFCompareLessThan;
  if (*fn2 == _PerformSecuritySendHandshake_NoLock)
    return kCFCompareGreaterThan;

  if (*fn1 == _PerformSecurityHandshake_NoLock)
    return kCFCompareLessThan;
  if (*fn2 == _PerformSecurityHandshake_NoLock)
    return kCFCompareGreaterThan;
#endif
...
/* static */ void _SocketStreamAttemptAutoVPN_NoLock(_CFSocketStreamContext* ctxt, CFStringRef name)
{
  if (!__CFBitIsSet(ctxt->_flags, kFlagBitTriedVPN)) {
    ...
    options = CFDictionaryCreate(alloc, (const void**)keys, (const void**)values, sizeof(values) / sizeof(values[0]), &kCFTypeDictionaryKeyCallBacks,
    ...
    if (!options) {
      ...
      if (SCNetworkConnectionCopyUserPreferences(options, &service_id, &user_options)) {
        ...
        SCNetworkConnectionRef conn =
            SCNetworkConnectionCreateWithServiceID(alloc, service_id, (SCNetworkConnectionCallBack)_NetworkConnectionCallBack, &c);
...
/* static */ void _SocketStreamPerformCancel(void* info) { (void)info; /* unused */ }
...
/* static */ void _PerformSOCKSv5Handshake_NoLock(_CFSocketStreamContext* ctxt)
{
  do {
    ...
    CFMutableDataRef to_send = (CFMutableDataRef)CFDictionaryGetValue(ctxt->_properties, _kCFStreamPropertySOCKSSendBuffer);
    CFMutableDataRef to_recv = (CFMutableDataRef)CFDictionaryGetValue(ctxt->_properties, _kCFStreamPropertySOCKSRecvBuffer);
    ...
    if (!to_recv) {
      ...
      if (!to_send) {
        ...
        if (name)
          ...
          if (list && CFArrayGetCount(list)) {
            name = _CFNetworkCFStringCreateWithCFDataAddress(CFGetAllocator(list), (CFDataRef)CFArrayGetValueAtIndex(list, 0));
          }
...
/* static */ Boolean _SOCKSSetInfo_NoLock(_CFSocketStreamContext* ctxt, CFDictionaryRef settings)
{
  ...
  */
  if ((settings && (CFDictionaryGetTypeID() != CFGetTypeID(settings))) || __CFBitIsSet(ctxt->_flags, kFlagBitOpenComplete) ||
      __CFBitIsSet(ctxt->_flags, kFlagBitOpenStarted) || __CFBitIsSet(ctxt->_flags, kFlagBitCreatedNative)) {
    return FALSE;
  }
  ...
  if (!old || !CFEqual(old, settings)) {
    ...
    /* Client is setting the proxy. */
      ...
      if (!name) {
        ...
        if (!_CFNetworkDoesNeedProxy(name, CFDictionaryGetValue(settings, kCFStreamPropertyProxyExceptionsList),
      ...
      if (!_SocketStreamAddHandshake_NoLock(
              ctxt, CFEqual(version, kCFStreamSocketSOCKSVersion4) ? _PerformSOCKSv4Handshake_NoLock : _PerformSOCKSv5Handshake_NoLock))
        return FALSE;
...
/* static */ void _SocketStreamSOCKSHandleLookup_NoLock(_CFSocketStreamContext* ctxt, CFHostRef lookup)
{
  ...
  if (user) {
    user_len = CFStringGetBytes(user, CFRangeMake(0, CFStringGetLength(user)), kCFStringEncodingUTF8, 0, FALSE, NULL, 0, NULL);
  }
  ...
  if (name) {
    ...
    CFStringGetBytes(name, CFRangeMake(0, CFStringGetLength(name)), kCFStringEncodingUTF8, 0, FALSE, ptr + 8 + user_len - 1, extra, NULL);
  ...
  if (user) {
    CFStringGetBytes(user, CFRangeMake(0, CFStringGetLength(user)), kCFStringEncodingUTF8, 0, FALSE, ptr + 8, user_len - 1, NULL);
  }
...
/* static */ Boolean _CONNECTSetInfo_NoLock(_CFSocketStreamContext* ctxt, CFDictionaryRef settings)
{
   ...
   ** connected socket.
   */
  if ((settings && (!server || !port)) || __CFBitIsSet(ctxt->_flags, kFlagBitCreatedNative)) {
    return FALSE;
  }
...
/* static */ CFIndex _SocketStreamSecuritySend_NoLock(_CFSocketStreamContext* ctxt, const UInt8* buffer, CFIndex length)
{
  ...
  SSLContextRef ssl    = *((SSLContextRef*)CFDataGetBytePtr((CFDataRef)CFDictionaryGetValue(ctxt->_properties, kCFStreamPropertySocketSSLContext)));
    ...
    if (result) {
      ...
      if (!check || (CFBooleanGetValue(check) == FALSE)) {
        ...
        if (SSLGetNegotiatedCipher(ssl, &cipherSuite) == noErr) {
          if (cipherSuite == SSL_DH_anon_EXPORT_WITH_RC4_40_MD5 || cipherSuite == SSL_DH_anon_WITH_RC4_128_MD5 ||
              ...
              cipherSuite == TLS_DH_anon_WITH_AES_128_CBC_SHA || cipherSuite == TLS_DH_anon_WITH_AES_256_CBC_SHA) {
...
/* extern */ void CFStreamCreatePairWithSocketToCFHost(CFAllocatorRef    alloc,
                                                       CFHostRef         host,
                                                       UInt32            port,
                                                       CFReadStreamRef*  readStream,
                                                       CFWriteStreamRef* writeStream)
...
/* extern */ void CFStreamCreatePairWithSocketToNetService(CFAllocatorRef    alloc,
...
/* extern */ Boolean CFSocketStreamPairSetSecurityProtocol(CFReadStreamRef                socketReadStream,
                                                           ...
                                                           CFStreamSocketSecurityProtocol securityProtocol)
{
  ...
  if (socketReadStream) {
    result = CFReadStreamSetProperty(socketReadStream, kCFStreamPropertySocketSecurityLevel, value);
  }

  /* If there was no read stream, try the write stream */
  else if (socketWriteStream) {
    result = CFWriteStreamSetProperty(socketWriteStream, kCFStreamPropertySocketSecurityLevel, value);
  }
                                                           ...
                                                           CFWriteStreamRef* writeStream)
{
  ...
  if (ctxt) {
    ...
    CFStringRef     keys[]        = {_kCFStreamSocketFamily, _kCFStreamSocketType, _kCFStreamSocketProtocol};
    SInt32          values[]      = {protocolFamily, socketType, protocol};
    CFDictionaryRef props         = CFDictionaryCreate(alloc, (const void**)keys, (const void**)values, (sizeof(values) / sizeof(values[0])),
                                                       &kCFTypeDictionaryKeyCallBacks, &cb);
...
/* extern */ void CFStreamCreatePairWithNetServicePieces(CFAllocatorRef    alloc,
                                                         CFStringRef       domain,
                                            ...
                                            CFWriteStreamRef*        writeStream)
{
  ...
  /* Being created with a CFSocketSignature? */
    ...
    _CFStreamCreatePairWithCFSocketSignaturePieces(alloc, sig->protocolFamily, sig->socketType, sig->protocol, sig->address, readStream, writeStream);
  }
