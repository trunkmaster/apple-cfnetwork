 ...
 *    Non-Carbon CFM:   not available
 */
extern CFTypeID CFHostGetTypeID(void) AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER;
 ...
 *    Non-Carbon CFM:   not available
 */
extern CFHostRef CFHostCreateWithName(CFAllocatorRef allocator, CFStringRef hostname) AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER;
 ...
 *    Non-Carbon CFM:   not available
 */
extern CFHostRef CFHostCreateWithAddress(CFAllocatorRef allocator, CFDataRef addr) AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER;
 ...
 *    Non-Carbon CFM:   not available
 */
extern CFHostRef CFHostCreateCopy(CFAllocatorRef alloc, CFHostRef host) AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER;
 ...
 *    Non-Carbon CFM:   not available
 */
extern Boolean CFHostStartInfoResolution(CFHostRef      theHost,
                                         CFHostInfoType info,
 ...
 *    Non-Carbon CFM:   not available
 */
extern CFArrayRef CFHostGetAddressing(CFHostRef theHost, Boolean *hasBeenResolved) /* can be NULL */ AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER;
 ...
 *    Non-Carbon CFM:   not available
 */
extern CFArrayRef CFHostGetNames(CFHostRef theHost, Boolean *hasBeenResolved) /* can be NULL */ AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER;
 ...
 *    Non-Carbon CFM:   not available
 */
extern CFDataRef CFHostGetReachability(CFHostRef theHost, Boolean *hasBeenResolved) /* can be NULL */ AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER;
 ...
 *    Non-Carbon CFM:   not available
 */
extern void CFHostCancelInfoResolution(CFHostRef theHost, CFHostInfoType info) AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER;
 ...
 *    Non-Carbon CFM:   not available
 */
extern Boolean CFHostSetClient(CFHostRef            theHost,
 ...
 *    Non-Carbon CFM:   not available
 */
extern void CFHostScheduleWithRunLoop(CFHostRef theHost, CFRunLoopRef runLoop, CFStringRef runLoopMode) AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER;
 ...
 *    Non-Carbon CFM:   not available
 */
extern void CFHostUnscheduleFromRunLoop(CFHostRef theHost, CFRunLoopRef runLoop, CFStringRef runLoopMode) AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER;
